...
try:
  from tensorflow_metadata.proto.v0.schema_pb2 import Schema as schema_pb2_Schema
...
def read_string_file(file_name: Text) -> Text:
  ...
  return file_io.open(file_name).read()


class SchemaReader(object):
  """Schema reader."""

  def read(self, schema_path: Text) -> schema_pb2_Schema:
    ...
    contents = file_io.open(schema_path).read()
